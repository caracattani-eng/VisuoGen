...
// ── Generate image from text (no source image) ──
...
// ── Image to image — keeps your exact product ──
...
// ── Stability AI image to image (highest quality product preservation) ──
app.post("/api/stability", upload.single("image"), async (req, res) => {
  try {
    ...
    form.append("text_prompts[1][text]", "blurry, bad quality, distorted product, changed product");
